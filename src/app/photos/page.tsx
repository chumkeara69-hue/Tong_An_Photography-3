  ...
  return (
    <main className="container section gallery-page">
      <div className="page-heading">
        ...
        <p className="lead">
          Original images made by Tong An Photography. Explore by subject and
          open any photograph to see the story, price and licensing details.
        </p>
      </div>
      ...
      {photosWithUrls.length ? (
            ...
            >
              ...
              <div className="photo-info">
                <div>
                  ...
                  <small>
                    Licensed original · Digital download
                  </small>
                </div>
        ...
        <div className="empty card">
          ...
          <p>
            Try another collection or browse all photographs.
          </p>
